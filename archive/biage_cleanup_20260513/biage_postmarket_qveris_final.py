...
class BiagePostmarketAnalyzerFinal:
    """彪哥战法盘后分析器（QVeris最终版）"""
    ...
    def __init__(self):
        ...
        self.search_id = "5eabba27-5e95-4532-8fb2-cce32091d8f6"  # 从之前的搜索获取
    ...
    def get_market_summary(self):
        ...
        try:
            ...
            if gainers_result and losers_result:
                ...
                summary["data_source"] = "QVeris/FMP（真实数据）"
...
"""
    ...
    def save_report(self, report):
        """保存报告"""
        # 保存到workspace
        workspace_file = f"/Users/tuqibiao/.openclaw/workspace/reports/postmarket_qveris_final_{self.date_str}.txt"
        with open(workspace_file, 'w', encoding='utf-8') as f:
            f.write(report)
        
        # 保存到临时文件
        temp_file = f"/tmp/postmarket_qveris_final_{self.date_str}.log"
...
def main():
    """主函数"""
    try:
        analyzer = BiagePostmarketAnalyzerFinal()
        result = analyzer.run()
