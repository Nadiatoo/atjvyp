        ...
        rules = {
            "normal_evolution": {
                ...
                MarketState.SPRING_SUMMER_TRANSITION: {
                    "next_states": [
                        {"state": MarketState.SUMMER, "probability": 70},
                        {"state": MarketState.SPRING, "probability": 20},
                        {"state": MarketState.CHAOS, "probability": 10}
                    ]
                },
                MarketState.SUMMER: {
                    "next_states": [
                        {"state": MarketState.SUMMER_AUTUMN_TRANSITION, "probability": 65},
                        {"state": MarketState.SUMMER, "probability": 30},
                        {"state": MarketState.CHAOS, "probability": 5}
                    ]
                },
                MarketState.SUMMER_AUTUMN_TRANSITION: {
                    "next_states": [
                        {"state": MarketState.AUTUMN, "probability": 70},
                        {"state": MarketState.SUMMER, "probability": 20},
                        {"state": MarketState.CHAOS, "probability": 10}
                    ]
                },
                MarketState.AUTUMN: {
                    "next_states": [
                        {"state": MarketState.AUTUMN_WINTER_TRANSITION, "probability": 65},
                        {"state": MarketState.AUTUMN, "probability": 25},
                        {"state": MarketState.CHAOS, "probability": 10}
                    ]
                },
                MarketState.AUTUMN_WINTER_TRANSITION: {
                    "next_states": [
                        {"state": MarketState.WINTER, "probability": 70},
                        {"state": MarketState.AUTUMN, "probability": 20},
                        {"state": MarketState.CHAOS, "probability": 10}
                    ]
                },
                MarketState.CHAOS: {
                    "next_states": [
                        {"state": MarketState.WINTER_SPRING_TRANSITION, "probability": 30},
                        {"state": MarketState.SPRING, "probability": 25},
                        {"state": MarketState.AUTUMN, "probability": 25},
                        {"state": MarketState.CHAOS, "probability": 20}
                    ]
                }
            },
            "jump_rules": [
